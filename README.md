...
## The Game
The game is a 2D pixel platformer consisting of three small levels. It can be played with keyboard or game controller and the UI also handles mouse control.
