...
[Stately](https://github.com/britzl/stately) finite state machine library.  The game also demonstrates how to implement basic UI screens and handles input from keyboard, controller, mouse and mobile touch screens.
